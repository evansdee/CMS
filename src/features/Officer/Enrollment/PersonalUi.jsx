...
export default function PersonalUi({register,isLoading,country,state,errors}) {
  ...
  return (
    ...
    <div>
          <Form.FormMultipleRow>
            <FileInput type="file" accept="image/*" {...register("photo",{required:'nigga enter'})} 
          ...
          <Form.FormMultipleRow>
            <Label label="Date of Birth" error={errors?.dob?.message}>
              <Input {...register("dob",{required:'This field is required'})} type="date" />
            </Label>
            <Label label="Gender">
